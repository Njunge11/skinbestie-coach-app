...
vi.mock("@/app/api/admins/admins.repo", () => ({
  makeAdminsRepo: () => ({
...
async function authorize(
  ...
  adminsRepo: { findByEmail: typeof mockFindByEmail },
) {
...
describe("NextAuth authorize function", () => {
  ...
  describe("Success cases", () => {
    it("returns user object when credentials are valid", async () => {
      ...
      vi.mocked(mockFindByEmail).mockResolvedValue(mockAdmin);
  ...
  describe("Validation errors", () => {
    ...
    it("returns null when credentials are empty object", async () => {
      // Act
      const result = await authorize({}, { findByEmail: mockFindByEmail });
  ...
  describe("Error cases", () => {
    it("returns null when admin does not exist", async () => {
      // Arrange
      vi.mocked(mockFindByEmail).mockResolvedValue(undefined);
